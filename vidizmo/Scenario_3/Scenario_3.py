...
#clicking the like and Heart button
app.find_element_by_xpath("(//i[@id='thumbsUp'])[2]").click()
time.sleep(3)
#app.find_element_by_xpath("//*[@id='thumbsUp']").click()
app.find_element_by_id("thumbsUp").click()
